...
(function () {
    ...
    var petColorTexture = "https://theanine3d.github.io/assets/pets/colors.png";
    var petRoughnessTexture = "https://theanine3d.github.io/assets/pets/r_50.png";
    var petMetallicTexture = "https://theanine3d.github.io/assets/pets/r_0.png";
    ...
    for (var j = 0; j < LIST_SPECIES.length; j++) {
        ...
        for (var k = 0; k < LIST_MOODS.length; k++) {
            ...
            for (var i = 0; i < LIST_ANIMATIONS.length; i++) {
                var animationURL = "https://theanine3d.github.io/assets/pets/anims/" + LIST_SPECIES[j] + " anim " + LIST_ANIMATIONS[i] + LIST_MOODS[k] + ".fbx";
    ...
    LIST_SPECIES.forEach(function (name) {
        for (i = 0; i < 10; i++) {
            var speciesURL = "https://theanine3d.github.io/assets/pets/" + name + ".fbx";
            var thumbnailURL = "https://theanine3d.github.io/assets/pets/thumbnails/" + name + i + ".png";
    ...
    function setupPet(respawning) {
        ...
        petEntityID = Entities.addEntity(Script.require("https://theanine3d.github.io/assets/pets/pet.json"), "avatar");

        if (respawning === false) {
            Entities.editEntity(petEntityID, {
                "modelURL": "https://theanine3d.github.io/assets/pets/Egg.fbx",
            ...
            Entities.editEntity(petEntityID, {
                "modelURL": "https://theanine3d.github.io/assets/pets/" + LIST_SPECIES[pet.petSpecies] + ".fbx",
                "rotation": { x: 0, y: 0, z: 0 }
            });
            Entities.editEntity(petEntityID, {
                "parentID": petOwner.uuid,
        ...
        petNametagEntityID = Entities.addEntity(Script.require("https://theanine3d.github.io/assets/pets/nametag.json"), "avatar");
        updateNameTag(false);
    }
